    ...
    days:
      - date: 2023-10-2
        events:
          ...
          "<small><i><span style='display: inline-block; padding-left: 80px'><b>Keywords:</b> Jupyter notebooks, expressions, variables, assignment, functions, imports, int, float</span></i></small>":
      - date: 2023-10-4
        events:
          ...
          "<small><i><span style='display: inline-block; padding-left: 80px'><b>Keywords:</b> data types (int, float, str) and conversions, mean, median, lists, arrays, array arithmetic</span></i></small>":
      ...
      - date: 2023-10-6
        events:
          ...
          "<small><i><span style='display: inline-block; padding-left: 80px'><b>Keywords:</b> array methods, np.arange, US states, .read_csv, .get, .assign, .sort_values, .iloc, .loc, index</span></i></small>":
